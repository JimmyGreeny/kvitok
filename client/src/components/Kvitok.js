...
class EditableTimerList extends React.Component {
  render() {
    ...
    return (
      ...
      <div className="row">
        <div className="col">
          <h2 className="d-flex justify-content-center"><b>АКТ-КВИТАНЦИЯ</b></h2>
          ...
          <table className="table table-sm table-bordered border-dark table-striped table-hover m-0">
            <tbody>
              <tr>
                ...
                <th scope="col" className="align-middle text-center">НДС 20%</th>
                <th scope="col" className="align-middle text-center">Тариф с НДС</th>
                <th scope="col" className="align-middle text-center">кол-во</th>
                <th scope="col" className="align-middle text-center">сумма,р</th>
              </tr>
              {serv_rows}
              <TimerForm
              ...
              <tr>
                ...
                <th scope="col" className="align-middle text-center">НДС 20%</th>
                <th scope="col" className="align-middle text-center">Стоим. с НДС</th>
                <th scope="col" className="align-middle text-center">кол-во</th>
                <th scope="col" className="align-middle text-center">сумма,р</th>
              </tr>
              {material_rows}
  ...
  const handleTrashClick = () => {
    ...
    return (
      <tr>
        ...
        <td>
          <input className="inrow_material_price" value={price} onChange={updatePrice} />
        </td>
        <td>
          {price * 0.2}
        </td>
...
function  TotalSum (props) {
  ...
  const serv_rows = props.serv_rows;
    ...
    return (
      <tr>
        <th scope="col" className="align-middle text-end">ИТОГО по Акту-квит.:</th>
    ...
    return (
      <div>
        ...
        >
          <thead>
            <tr>
              <th scope="col" className="align-middle text-center">Наименование</th>
              <th scope="col" className="align-middle text-center">Стоимость</th>
            </tr>
          </thead>
          <tbody>
            <tr>
